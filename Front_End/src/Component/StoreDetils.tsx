			...
			<div className="p-3">
				<div>
					...
					<div className="bg-white p-3 shadow-lg mt-3" id="fish">
						...
						<div className="row">
							{fishs?.map((fish) => (
								<ProductCard key={fish._id} product={fish}></ProductCard>
							))}
						</div>
					</div>
					...
					<div className="bg-white p-3 shadow-lg mt-3" id="biryani">
						...
						<div className="row">
							{biryanis?.map((biryani) => (
								<ProductCard key={biryani._id} product={biryani}></ProductCard>
							))}
						</div>
					</div>
					<div className="bg-white p-3 shadow-lg mt-3" id="chicken">
						...
						<div className="row">
							{chickens?.map((chicken) => (
								<ProductCard key={chicken._id} product={chicken}></ProductCard>
							))}
						</div>
					</div>
					<div className="bg-white p-3 shadow-lg mt-3" id="soup">
						...
						<div className="row">
							{soups?.map((soup) => (
								<ProductCard key={soup._id} product={soup}></ProductCard>
							))}
						</div>
					</div>
				</div>
